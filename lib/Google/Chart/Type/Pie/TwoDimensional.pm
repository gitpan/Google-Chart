...
Google::Chart::Type::Pie::TwoDimensional - Draw a chart with Google Chart

=head1 SYNOPSIS

    Google::Chart::Type::Pie::TwoDimensional->new;
...
This document describes version 0.04 of L<Google::Chart::Type::Pie::TwoDimensional>.
