...
Google::Chart::Type::Pie::ThreeDimensional - Draw a chart with Google Chart

=head1 SYNOPSIS

    Google::Chart::Type::Pie::ThreeDimensional->new;
...
Google::Chart::Type::Pie::ThreeDimensional inherits from
...
This document describes version 0.04 of L<Google::Chart::Type::Pie::ThreeDimensional>.
