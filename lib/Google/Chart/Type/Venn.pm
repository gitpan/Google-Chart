...
Google::Chart::Type::Venn - Draw a chart with Google Chart

=head1 SYNOPSIS

    Google::Chart::Type::Venn->new;
...
Google::Chart::Type::Venn inherits from L<Google::Chart::Type>.
...
This document describes version 0.03 of L<Google::Chart::Type::Venn>.
