...
Google::Chart::Type::Line - Draw a chart with Google Chart

=head1 SYNOPSIS

    Google::Chart::Type::Line->new;
...
Google::Chart::Type::Line inherits from L<Google::Chart::Type>.
...
This document describes version 0.04 of L<Google::Chart::Type::Line>.
