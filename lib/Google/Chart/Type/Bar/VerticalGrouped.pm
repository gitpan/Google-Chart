...
Google::Chart::Type::Bar::VerticalGrouped - Draw a chart with Google Chart

=head1 SYNOPSIS

    Google::Chart::Type::Bar::VerticalGrouped->new;
...
Google::Chart::Type::Bar::VerticalGrouped inherits from
...
This document describes version 0.02 of L<Google::Chart::Type::Bar::VerticalGrouped>.
