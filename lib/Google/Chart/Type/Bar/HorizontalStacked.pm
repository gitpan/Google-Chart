...
Google::Chart::Type::Bar::HorizontalStacked - Draw a chart with Google Chart

=head1 SYNOPSIS

    Google::Chart::Type::Bar::HorizontalStacked->new;
...
Google::Chart::Type::Bar::HorizontalStacked inherits from
...
This document describes version 0.04 of L<Google::Chart::Type::Bar::HorizontalStacked>.
