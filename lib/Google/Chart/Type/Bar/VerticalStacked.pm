...
Google::Chart::Type::Bar::VerticalStacked - Draw a chart with Google Chart

=head1 SYNOPSIS

    Google::Chart::Type::Bar::VerticalStacked->new;
...
Google::Chart::Type::Bar::VerticalStacked inherits from
...
This document describes version 0.02 of L<Google::Chart::Type::Bar::VerticalStacked>.
