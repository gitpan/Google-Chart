...
Google::Chart::Type::Line::LineXY - Draw a chart with Google Chart

=head1 SYNOPSIS

    Google::Chart::Type::Line::LineXY->new;
...
Google::Chart::Type::Line::LineXY inherits from
L<Google::Chart::Type::Line>.
...
This document describes version 0.04 of L<Google::Chart::Type::Line::LineXY>.
